...
export const projects: Project[] = [
  ...
  },
  {
    ...
    navLabel: "BLDC Controller",
    hook: "Two round boards that only agree on one thing: exactly where the rotor is, a hundred thousand times a second.",
    detail:
    ...
    technologies: [
      ...
      "3x INA240",
      "CAN FD Daisy-Chain",
      "Molex Board-to-Board",
    ],
    size: "large",
  },
  {
    id: "tea-cozy-hotplate",
    title: "Tea Cozy Hotplate",
    navLabel: "Tea Cozy Hotplate",
    hook: "The heating element is just the PCB itself, etched into a spiral and told to misbehave a little.",
    detail:
